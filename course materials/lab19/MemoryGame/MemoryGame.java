...
public class MemoryGame {
    ...
    public static void main(String[] args) {
       ...
       long seed = Long.parseLong(args[0]);
        // long seed = Long.parseLong(28888);
    ...
    public String generateRandomString(int n) {
        ...
        String genarate = "";
        for (int i = 0; i < n; i++) {
            int k = RandomUtils.uniform(rand, 25);
            genarate = genarate + CHARACTERS[k];
        }
        return genarate;
    }
...
//        }
    ...
    public String solicitNCharsInput(int n) {
        ...
        while (genarate.length() < n) {
            if (StdDraw.hasNextKeyTyped()) {
                genarate += Character.toString(StdDraw.nextKeyTyped());
                this.drawFrame(genarate);
            } 
        }
        return genarate;
    }
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            StdDraw.pause(500);
            letters = generateRandomString(this.round);
            flashSequence(letters);

            this.playerTurn = true;
            this.drawFrame("");
            answer = solicitNCharsInput(this.round);
            StdDraw.pause(500);
