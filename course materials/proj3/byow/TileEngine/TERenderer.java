...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world) {
        ...
        if (mousePos[0] != 0.0d && mousePos[1] != 0.0d) {
            if (mousePos[0] < this.width && mousePos[1] < this.height 
                    && mousePos[0] > 0 && mousePos[1]  > 0) {
                String item = world[(int) mousePos[0]][(int) mousePos[1]].getDescription();
                StdDraw.textLeft(5, this.height - 5, item);   
            }
        }
