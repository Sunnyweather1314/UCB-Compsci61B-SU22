    ...
    public boolean tilt(Side side) {
        ...
        for (int c = 0; c < size(); c ++) {
            ...
            for (int r = 3; r >= 0; r--) {
                ...
                Tile nextTile = tile(c, nextLine);
                if (curr == null || nextTile == null) {
                    break;
                }
    ...
    public static boolean atLeastOneMoveExists(Board b) {
        ...
        for(int r = 0; r< b.size()-1;r ++){
            for(int c = 0; c< b.size()-1;c ++){
                ...
                System.out.println("Leftright : " + b.tile(c, r).value() +""+b.tile(c+1, r).value());
                if (b.tile(c, r).value() == b.tile(c, r+1).value() || b.tile(c, r).value() == b.tile(c+1, r).value()) {
                    return true;
                }
            }
        }
