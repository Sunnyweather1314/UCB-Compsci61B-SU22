public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        ...
        RBTreeNode<T> crr_root = node.left;

        node.left = crr_root.right;
        crr_root.right =node;



        crr_root.isBlack = node.isBlack;
        node.isBlack = false;
    ...
    RBTreeNode<T> rotateLeft(RBTreeNode<T> node) {
        ...
        RBTreeNode<T> crr_root = node.right;

        node.right = crr_root.left;
        crr_root.left =node;
    ...
    private RBTreeNode<T> insert(RBTreeNode<T> node, T item) {
        ...
        RBTreeNode<T> crr_node = node;


        // handle "middle of three" and "right-leaning red" structures
        if(isRed(crr_node.right) && !isRed(crr_node.left)){
            crr_node = rotateLeft(crr_node);
        }
        ...
        if(isRed(crr_node.left) && isRed(crr_node.left.left)){
            crr_node = rotateRight(crr_node);
        }
...
//        }
        ...
        // TODO: YOUR CODE HERE
        return crr_node; //fix this return statement
    }
